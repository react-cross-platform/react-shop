...
interface IDataFilteredProducts {
    ...
    return (
      ...
      >
        ...
        <Progress
          ...
          unfilled={true}
        />
        <Accordion activeKey={filters.map((filter) => String(filter.id))} className={styles.accordion}>
          ...
          >
            <MyTouchFeedback style={{ borderRadius: "1.5rem", backgroundColor: "lightgray" }}>
              <MyIcon
                ...
                style={{
                  fill: filters.filter((filter) => filter.hasChecked).length > 0 ? "orange" : "lightgray"
                }}
              />
            </MyTouchFeedback>
          </Flex>
          ...
          header={
            ...
            >
              {filter
                ...
                .map((value, i) => (
                  <div key={i} className={styles.colorItem} onClick={() => this.handleSelect(value)}>
