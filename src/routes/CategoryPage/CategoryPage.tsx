...
export interface IDataAllProduct {
...
class CategoryPage extends React.Component<Props, State> {
  ...
  componentWillReceiveProps(nextProps: Props) {
    ...
    if (nextProps.dataAllProducts.allProducts) {
      const loadedSubProducts = this.getSubProductsLength(nextProps.dataAllProducts.allProducts.products);
      ...
      if (
        ...
        loadedSubProducts !== this.getSubProductsLength(this.props.dataAllProducts.allProducts.products)
      ) {
  ...
  shouldComponentUpdate(nextProps: Props, nextState: State) {
    ...
    if ((dataCategory && dataCategory.loading) || dataAllProducts.loading || !dataAllProducts.allProducts) {
      return false;
    }
  ...
  render() {
    ...
    return (
      <Layout location={location} history={history} {...this.getLayoutOptions()}>
        {(dataCategory && dataCategory.loading) || dataAllProducts.loading || !dataAllProducts.allProducts ? (
          <LoadingMask />
        ) : (
          <Aux>
  ...
  getScrolledProducts = (scrollTop) => {
    const { dataAllProducts } = this.props;
    return Math.round((scrollTop / this.bottomHeight) * dataAllProducts.allProducts.products.length);
  };
...
export default compose(
  ...
  graphql<GraphQLProps>(CATEGORY_QUERY, categoryOptions as any),
  graphql<GraphQLProps, OwnProps>(ALL_PRODUCTS_QUERY, allProductsOptions as any)
